...
public class SearchAlgorithm implements iEntityProcessingService {
    ...
    /**
     * Generates a grid which allows path finding to be done in a grid based
     * manner
     *
    ...
    /**
     * Generates the walls in the grid based system, allowing the pathing to
     * detect immovable walls
     *
    ...
    /**
     * Processes the AStar algorithm which allows a path to be generated for an
     * enemy
     *
